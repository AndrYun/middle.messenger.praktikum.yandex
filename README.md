...
## Были добавлены тесты Jest

- тест для общего комопнента Button
- тест на EventBus
- тест на общий блок Block
- тест на Роутер
- тест HTTP запросы
- тест на Стор
...
Добален pre-commit. По команде git commit запускается линтер и тесты, после успешного заершения делается коммит
